...
export default function AddJob(){
    ...
    return(<form onSubmit={onSubmitHandler} className="container p-4 flex flex-col w-full items-start gap-3">
        <div className="w-full">
            <p className="mb-2">Job Title</p>
            <input type="text" placeholder="Type Here" onChange={e=>setTitle(e.target.value)}
             required 
                className="w-ful max-w-lg px-3 py-2 border-2 border-gray-300 rounded"
             />
        </div>
